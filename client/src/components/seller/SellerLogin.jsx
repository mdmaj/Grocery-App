...
const SellerLogin = () => {
  const { isSeller, setIsSeller, navigate, axios } = useAppContext(); // ✅ context se sab le rahe hain
  ...
  return (
    <div className="fixed top-0 left-0 bottom-0 right-0 z-30 flex items-center justify-center bg-black/50 text-gray-600">
      ...
      >
        ...
        <button className="bg-orange-500 hover:bg-orange-600 transition-all text-white w-full py-2 rounded-md cursor-pointer">
          Login
        </button>
      </form>
    </div>
